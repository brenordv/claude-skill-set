...
- If detailed examples are required, open `resources/requirement-extraction-implementation-playbook.md`.

## Resources

- `resources/requirement-extraction-implementation-playbook.md` for detailed patterns and examples.
