...
- If detailed examples are required, open `resources/dependency-scanning-implementation-playbook.md`.
...
- `resources/dependency-scanning-implementation-playbook.md` for detailed patterns and examples.
