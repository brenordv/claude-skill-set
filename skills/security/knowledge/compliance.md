...
- If detailed examples are required, open `resources/compliance-implementation-playbook.md`.
...
- `resources/compliance-implementation-playbook.md` for detailed patterns and examples.
